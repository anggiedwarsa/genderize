  ...
  group('getPrediction', () {
    ...
    test(
      ...
      () async {
        ...
        // assert
        verify(mockDio.get(tBaseUrl, queryParameters: anyNamed('queryParameters')));
      },
    );
    ...
    test(
      'pastikan akan meneriima exception DioError ketika menerima respon kegagalan dari endpoint',
      () async {
        // arrange
        final response = Response(
          requestOptions: tRequestOptions,
